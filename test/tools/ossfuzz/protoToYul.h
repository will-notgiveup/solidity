...
private:
	...
	/// @param _f is the function call to be visited. @param _name is
	/// the name of the function called. @param _expression is a flag
	/// that is true if the function is called as a single-value
